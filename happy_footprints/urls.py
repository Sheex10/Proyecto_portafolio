...
urlpatterns = [
    ...
    path('agregar_carrito2/<id>', agregar_carrito2, name="agregar_carrito2"),
    path('eliminar_producto_carrito/<int:id>', eliminar_producto_carrito, name="eliminar_producto_carrito"),
]
